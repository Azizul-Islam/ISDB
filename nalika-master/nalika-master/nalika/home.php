...
<?php require_once("modals/productClass.php"); ?>
<!doctype html>
    ...
    <div class="all-content-wrapper">
        ...
        <?php 
          if(isset($_GET["page"])){
            ...
            }elseif($page=='product-cart'){
              include('pages/product_cart.php');
            }elseif($page=='product-payment'){
              include('pages/product_payment.php');
