        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="home.php"><img src="img/notification/4.jpg" alt="" /></a>
					<h2>Azizul <span class="min-dtn">Islam</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Dashboard" href="home.php"><span class="mini-sub-pro">Dashboard</span></a></li>
                                <li><a title="Product List" href="home.php?page=product-list"><span class="mini-sub-pro">Product List</span></a></li>
                                <li><a title="Product Edit" href="add-product"><span class="mini-sub-pro">Add Product</span></a></li>
                                <li><a title="Product Edit" href="home.php?page=product-edit"><span class="mini-sub-pro">Product Edit</span></a></li>
                                <li><a title="Product Detail" href="home.php?page=product-detail"><span class="mini-sub-pro">Product Detail</span></a></li>
                                <li><a title="Product Cart" href="home.php?page=product-cart"><span class="mini-sub-pro">Product Cart</span></a></li>
                                <li><a title="Product Payment" href="home.php?page=product-payment"><span class="mini-sub-pro">Product Payment</span></a></li>
                                <li><a title="Analytics" href="home.php?page=analytics"><span class="mini-sub-pro">Analytics</span></a></li>
                                <li><a title="Widgets" href="home.php?page=widgets"><span class="mini-sub-pro">Widgets</span></a></li>
                            </ul>
                        </li>
                        <li>
