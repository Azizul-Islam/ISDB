<?php
    if(isset($_POST["submitBtn"])){
        ...
        $products=new Product($name,$price,$quantity,$short_desc,$image,$category,$stock,$brand);
        $products->save();
                                    ...
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                <?php
                                                    $categoris=$db->query("select id,category_name as name from {$ex}categories");
                                                    $category_arr=[];
                                                    while(list($id,$name)=$categoris->fetch_row()){
                                                        $category_arr[$id]=$name;
                                                    } 

                                                
                                                    
                                                   echo "<select name='cmbCategory' class='form-control pro-edt-select form-control-primary'>";
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10" name="submitBtn" value="Save">
                                                    <input type="submit" class="btn btn-ctl-bt waves-effect waves-light" name="cancel" value="Discard" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
