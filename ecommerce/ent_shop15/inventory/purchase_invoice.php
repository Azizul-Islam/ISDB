        ...
        <div style="min-width: 600px">
            ...
            <div class="row">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                     <?php
                        ...
                        if(isset($_GET["id"])){
                            $id=$_GET["id"];
                        $query_rs=$db->query("select p.name,pd.Qty,pd.cost from {$ex}products p,{$ex}purchase pu,{$ex}purchasedetails pd where pd.product_id=p.id and pd.purchase_id=pu.id and pd.purchase_id='$id'");
                        }
                        while(list($name,$Qty,$cost)=$query_rs->fetch_row()){
                            echo "<tr>";
                ...
                <div class="text-right">
                    <button id="printInvoice" onclick="self.print()" class="btn btn-info"><i class="fa fa-print"></i> Print</button>
                </div>
            </main>
            <footer>
