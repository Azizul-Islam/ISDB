<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			<div class="profile-userpic">
				...
				<!-- <img src="images/users/<?php echo $_SESSION['s_photo']; ?>" class="img-responsive" alt=""> -->
			</div>
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-4">
				<em class="fa fa-shopping-cart">&nbsp;</em> Sales <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-4">
					<li><a class="" href="customer">
						<span class="fa fa-arrow-right">&nbsp;</span> Customer
					</a></li>
					<li><a class="" href="create-sales-invoice">
						<span class="fa fa-arrow-right">&nbsp;</span> Create Invoice
					</a></li>
					<li><a class="" href="sales-view">
