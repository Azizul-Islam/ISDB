<?php
  ...
  if(isset($_POST["btnSave"])){
    if(count($_SESSION["invoice"])>0){
        ...
        $purchase_at=date("Y-m-d",strtotime("2-11-2020"));
...
<div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i> ABC Ltd.
              ...
              <!-- info row -->
              <form name="frmPurchase" id="frmPurchase" action="#" method="post">
               <input type="hidden" name="txtMessage" />
               <input type="hidden" value="Save" name="btnSave" />
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b>Ref</b>
                  <?php
                    echo text_field_nolabel("txtRef");
                  ?> 
...
$(function(){
  ...
  $("#btnSubmit").on("click",function(){
    //alert()
    let message="Data from javascrit";
    if(confirm('Are you sure?')){
      document.frmPurchase.txtMessage.value=message;
      $("#frmPurchase").submit();
    }
