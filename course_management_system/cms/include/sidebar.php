...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
     ...
     <div class='user-panel mt-3 pb-3 mb-3 d-flex'>
        <div class='image'>
        <img src="assets/AdminLTE-3.0.5/dist/img/avatar.png" class='img-circle elevation-2' alt='User Image'>
        </div>
        <div class='info'>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="home.php?page=manage-contact" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Contact</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="home.php?page=create-user" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="home.php?page=manage-user" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage User</p>
                </a>
              </li>
            ...
            <li class="nav-item">
                <a href="home.php?page=help" class="nav-link">
